...
public partial class BookStoresDbContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Name=ConnectionStrings:BookStores");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Author>(entity =>
        {
            entity.HasKey(e => e.AuthorId).HasName("PK__Author__86516BCFD906BC3A");
        ...
        {
            entity.HasKey(e => e.BookId).HasName("PK__Book__490D1AE12058AE24");
        ...
        {
            entity.HasKey(e => e.JobId).HasName("PK__Job__6E32B6A5FC0970CC");
        ...
        {
            entity.HasKey(e => e.PubId).HasName("PK__Publishe__2515F222D74C99C9");
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__Role__760965CC9181A4FD");
